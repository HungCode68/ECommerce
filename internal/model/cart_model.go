...
type CheckoutPreviewRequest struct {
	...
	CouponCode         string  `json:"coupon_code" validate:"omitempty,min=3,max=50"` // Legacy alias of OrderCouponCode
...
type AppliedCouponPreview struct {
...
type CheckoutPreviewResponse struct {
	TotalPrice       float64               `json:"total_price"` // Backward-compatible alias of SubTotal
	...
	OrderCoupon      *AppliedCouponPreview `json:"order_coupon,omitempty"`
	ShippingCoupon   *AppliedCouponPreview `json:"shipping_coupon,omitempty"`

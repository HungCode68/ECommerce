...
type CouponsController interface {
	// Admin Methods
	CreateCoupon(ctx context.Context, req model.CreateCouponRequest) (model.CouponResponse, error)
	UpdateCoupon(ctx context.Context, id int64, req model.UpdateCouponRequest) (model.CouponResponse, error)

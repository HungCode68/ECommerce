          ...
          <div className="w-full max-w-md relative z-10">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <FacebookLoginButton className="rounded-xl">
                  <div className="flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-surface-container-lowest border border-outline-variant/20 hover:bg-surface-bright transition-all group">
              ...
              <form className="space-y-6" onSubmit={loginForm.handleSubmit(onLoginSubmit)}>
                ...
                <p className="text-[11px] text-on-surface-variant text-center mt-4 px-2 leading-relaxed">
                  Bằng việc đăng nhập, bạn đồng ý với <a href="/DKSD.pdf" target="_blank" rel="noopener noreferrer" className="text-[#f97316] font-bold hover:underline">Điều khoản dịch vụ</a> & <a href="/CSBM.pdf" target="_blank" rel="noopener noreferrer" className="text-[#f97316] font-bold hover:underline">Chính sách bảo mật</a> của KC Tech
                </p>

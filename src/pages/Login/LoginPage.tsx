          ...
          <div className="w-full max-w-md relative z-10">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <GoogleLoginButton className="rounded-xl h-[40px]" />
                <FacebookLoginButton className="rounded-xl h-[40px]">
                  <div className="flex items-center justify-center gap-3 h-full px-4 rounded-xl bg-surface-container-lowest border border-outline-variant/20 hover:bg-surface-bright transition-all group">
